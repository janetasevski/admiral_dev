...
class RouteTest extends TestCase
{
    ...
    public function authenticated_user_can_access_profile_routes()
    {
        ...
        $response = $this->actingAs($user)->put('/profile/edit', [
            'name' => $user->name,
            'email' => $user->email,
            'current_password' => 'password', // assuming the user's current password is 'password'
            'password' => 'newpassword', // set to new password
            'password_confirmation' => 'newpassword', // must match the new password
        ]);
    ...
    public function authenticated_user_can_access_employee_routes()
    {
        ...
        // Assuming there's an employee in the database with ID 1
    ...
    public function admin_can_access_users_routes()
    {
        ...
        // Assuming there's a user in the database with ID 1
    ...
    public function authenticated_user_can_access_car_routes()
    {
        ...
        // Assuming there's a car in the database with ID 1
